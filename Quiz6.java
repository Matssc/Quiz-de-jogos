...
public class Quiz6 {
     ...
     * Permite jogar quiz, acessar CRUD ou sair do programa.
     * Repete continuamente até o usuário escolher sair.
     */
    ...
    /**
     * Solicita o nome do jogador e valida a entrada.
     * Mostra saudação personalizada ao iniciar o quiz.
     */
    public static void nome() {
        ...
        do {
            ...
            nome = x.nextLine();
            if (nome.matches("[A-Za-zÀ-ÖØ-öø-ÿ]+")) break;
     ...
     * Em seguida, chama jogarQuiz(categoriaEscolhida).
     */
    public static void categorias() {
        try (Connection conn = conectar();
            ...
            jogarQuiz(categorias.get(escolha));
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
     ...
     * Mostra perguntas, lê respostas, indica acertos e exibe pontuação final.
     */
    public static void jogarQuiz(String categoria) {
        try (Connection conn = conectar()) {
